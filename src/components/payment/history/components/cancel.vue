  ...
  <div class="container card">
    <div class="tab_wrapper">
      ...
      <div class="payment__date">
        ...
        <p class="payment__date-time">2021/12/20</p>
      </div>
          ...
          <div class="table__box">
            ...
            <div class="table__box-value">
              <p>
                {{
                  cashFormatter(
                    parseInt(cancelId.TOTAL_AMOUNT) -
                      parseInt(cancelId.FEE_WITH_TAX_FOR_DISPLAY)
                  )
                }}<small>円</small>
              </p>
            </div>
...
<script src="@/assets/js/components/payment/history/components/cancel.js"></script>

<template>
  <div class="container card confirm-withdrawal">
      ...
      <div class="payment__table card card--sphidden">
        <div class="table">
          ...
          <div class="table__box">
            ...
            <div class="table__box-value">
              <p>{{ amountWithdrawal }}<small>円</small></p>
            </div>
          </div>
          <div class="table__box">
            <div class="table__box-title">
            ...
            <div class="table__box-value">
              <p>{{ feeWithdrawal }}<small>円</small></p>
            </div>
          </div>
          <div class="table__box">
            <div class="table__box-title">
          ...
          <div class="table__box">
            ...
            <div class="table__box-value">
              <p>
                {{ infoWithdrawal.WITHDRAW_ACNT_INF.WITHDRAW_ACCOUNT_NUMBER }}
              </p>
            </div>
          </div>
        </div>
...
<script src="@/assets/js/components/payment/withdrawal/components/confirm.js"></script>

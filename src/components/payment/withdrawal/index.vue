            ...
            <div class="payment__table card card--sphidden">
              <div class="table">
                  ...
                  <div class="table__box-value">
                    ...
                    <div class="counter order__data-counter">
                      ...
                      <input
                        ...
                        :value="
                          amoutInput === 0 ? 0 : cashFormatter(amoutInput)
                        "
                ...
                <div class="table__box">
                  ...
                  <div class="table__box-value">
                    <p>{{ WITHDRAW_FEE }}<small>円</small></p>
                  </div>
                </div>
              </div>
              ...
              <div class="table">
                ...
                <div class="table__box">
                  ...
                  <div class="table__box-value">
                    <p v-if="Object.keys(getDataAmount).length > 0">
                      {{
                        getDataAmount.WITHDRAW_ACNT_INF.WITHDRAW_ACCOUNT_NUMBER
                      }}
                    </p>
                  </div>
                </div>
...
<script src="@/assets/js/components/payment/withdrawal/index.js"></script>

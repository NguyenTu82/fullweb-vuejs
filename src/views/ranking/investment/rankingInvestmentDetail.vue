          ...
          <div class="tab_wrapper">
            <div class="ranking__title">
              ...
              <div class="ranking__title-caution">
                <a
                  href="https://www.cheer-sec.co.jp/other/app-help/B420.html"
                ...
                <p>※基準価格は{{ priceUpdateTime || "-" }}時点のものです</p>
              </div>
            </div>
            <div class="ranking__list card card--sphidden">
              <div class="ranking__list-head">
                ...
                <h2><small>基準価格</small><br />前日比</h2>
              </div>

              <div v-show="isShowData === true">
                <div
                  v-for="item in fundData.slice(0, page * pageInit)"
                  :key="item.id"
                >
                  <router-link
                    :to="{
                      name: 'InvestBrandDetail',
                      query: { inv_trust_assoc_cd: item.inv_trust_assoc_cd },
                    }"
                    v-slot="{ href, navigate }"
                    custom
                  >
                    ...
                    >
                      ...
                      <div class="ranking__list-item-name">
                        <p>{{ item.fund_abb_nm }}</p>
                        <p v-for="type in getFundTypeList(item)" :key="type.id">
                          <span class="tag tag--small">{{ type }}</span>
                        </p>
                      </div>
                          ...
                          <span
                            ...
                            {{
                              item.day_before_rate !== null
                                ? handNumberInt(item.day_before_rate)
                                : "-"
                            }}円
                          </span>
                          <span
...
<script src="@/assets/js/page/ranking/investment/rankingInvestmentDetail"></script>

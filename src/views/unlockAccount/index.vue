<template>
  <main class="no_header_padding">
    <section class="settings">
      ...
      <div class="wrapper">
        <section class="open">
          <h1 class="title">アカウントロック解除申請</h1>
          <div class="container card">
            <div class="tab_wrapper">
              <h2 class="open__title">アカウントロック解除申請</h2>
              ...
              <div
                class="open__input open__input--birthday open__input--nospace"
              >
                <div>
                  <select
                    ...
                    :style="{
                      color:
                        formData[2].modelVal[0] === '' ? '#757575' : '#000',
                    }"
                    autocomplete="off"
                  >
                ...
                <div>
                  <select
                    ...
                    :style="{
                      color:
                        formData[2].modelVal[1] === '' ? '#757575' : '#000',
                    }"
                    autocomplete="off"
                  >
                ...
                <div>
                  <select
                    ...
                    :style="{
                      color:
                        formData[2].modelVal[2] === '' ? '#757575' : '#000',
                    }"
                    autocomplete="off"
                  >
                    <option disabled selected hidden value="">
...
<script src="@/assets/js/page/unlockAccount/index.js"></script>

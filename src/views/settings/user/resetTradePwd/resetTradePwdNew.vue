    ...
    <TopInfo>
      <nav class="topinfo__breadcrumb">
        ...
        <router-link to="" v-slot="{ navigate }" custom>
          <a @click="navigate">取引暗証番号の再設定</a>
        </router-link>
      </nav>
    </TopInfo>
    <section class="settings">
      <div v-if="!doneFlag" class="wrapper">
        <h1 class="title">取引暗証番号の再設定</h1>
...
<script src="@/assets/js/page/settings/user/resetTradePwd/resetTradePwdNew.js"></script>
